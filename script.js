...
function renderProductCard(productData) {
	// Here is the structure for HTML cards. You have to design this using JavaScript.
...
//var clothingGrid = document.getElementById("clothing-grid");
var accessoriesCards =document.getElementById("accessoriesCards")
function renderProductCard1(productData) {
	// Here is the structure for HTML cards. You have to design this using JavaScript.
	// <div class="product-card">
	//     <img class="preview-image" src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/7579188/2018/11/5/08a7b230-ee8f-46c0-a945-4e835a3c01c01541402833619-United-Colors-of-Benetton-Men-Sweatshirts-1271541402833444-1.jpg" alt="Men Navy Blue Solid Sweatshirt" />
	...
	productInfoWrapper.appendChild(productPrice);
  productCard.appendChild(productInfoWrapper);
  accessoriesCards.appendChild(productCard);
}

for (var i = 0; i < productList1.length; i++) {
	renderProductCard1(productList1[i]);
}
